...
2228                     ; 12 	UART1_BRR1=0x68;     //9600 bod
2230  0000 35685232      	mov	_UART1_BRR1,#104
2231                     ; 13 	UART1_BRR2=0x03;
2233  0004 35035233      	mov	_UART1_BRR2,#3
2234                     ; 14 	UART1_CR2 |= UART1_CR2_REN; //reseiving
2236  0008 72145235      	bset	_UART1_CR2,#2
2237                     ; 15 	UART1_CR2 |= UART1_CR2_TEN; //transmiting 
2239  000c 72165235      	bset	_UART1_CR2,#3
2240                     ; 16 	UART1_CR2 |= UART1_CR2_RIEN; //reseive int
2242  0010 721a5235      	bset	_UART1_CR2,#5
2243                     ; 17 	UART1_SR = 0;
2245  0014 725f5230      	clr	_UART1_SR
2246                     ; 18 }
2249  0018 81            	ret
2287                     ; 20 void process_command(char *cmd)
2287                     ; 21 {
2288                     	switch	.text
2289  0019               _process_command:
2291  0019 89            	pushw	x
2292       00000000      OFST:	set	0
2295                     ; 26 	if(strncmp(cmd, "set", 3) == 0)
...
2306                     ; 32 	if(strncmp(cmd, "help", 4) == 0)
...
2318                     ; 34 		usart_send(help_msg, sizeof(help_msg)-1);
...
2330  004a 85            	popw	x
2331  004b 81            	ret
2367                     ; 37 void usart_send_byte(int byte)
2367                     ; 38 {
2368                     	switch	.text
